    ...
    for env_type in [""]:
        ...
        if "rlcard_envs" in envs_list:
            ...
            for i in os.listdir(os.path.join(env_type_path, "rlcard_envs")):
                if (not os.path.isdir(os.path.join(env_type_path, "rlcard_envs", i)) and i != "__init__.py"
...
# API information
            if "rlcard_envs" in env_dir_path:
                docs_text += f"""## API
```{{eval-rst}}
.. currentmodule:: free_range_zoo.rlcard_envs.{env_name}
...
"""
                ...
                relavent_classes = [
                    ...
                    if issubclass(getattr(submodule, cls_name), submodule.Configuration)
                ]

                docs_text += f"""## Configuration
```{{eval-rst}}

...
| Observation Shape  | TensorDict: { <br>&emsp;**self**: $<ypos, xpos, power, suppressant, range, capacity, equipment>$<br>&emsp;**others**: $<ypos, xpos, [power], [suppressant], [range], [capacity], [equipment]>$<br>&emsp;**tasks**: $<y, x, fire level, intensity>$ <br> **batch_size**: $num\_envs$ } |
| Observation Values | <u>**self**</u>:<br>&emsp;$ypos$: $[0, max_y]$<br>&emsp;$xpos$: $[0, max_x]$<br>&emsp;$power$: $[0, max_{effective\_power}]$<br>&emsp;$suppressant$: $[0, max_{effective\_suppressant}]$<br>&emsp;$range$: $[0, max_{effective\_range}]$<br>&emsp;$capacity$: $[0, max_{effective\_capacity}]$<br>&emsp;$equipment$: $[0, max_{equipment\_state}]$<br><u>**others**</u>:<br>&emsp;$ypos$: $[0, max_y]$<br>&emsp;$xpos$: $[0, max_x]$<br>&emsp;$[power]$: included if observe_other_power<br>&emsp;$[suppressant]$: included if observe_other_suppressant<br>&emsp;$[range]$: included if observe_other_range<br>&emsp;$[capacity]$: included if observe_other_capacity<br>&emsp;$[equipment]$: included if observe_other_equipment<br><u>**tasks**</u><br>&emsp;$ypos$: $[0, max_y]$<br>&emsp;$xpos$: $[0, max_x]$<br>&emsp;$fire\_level$: $[0, max_{fire\_level}]$<br>&emsp;$intensity$: $[0, num_{fire\_states}]$ |

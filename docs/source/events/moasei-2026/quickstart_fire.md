...
Here we use
[wildfire](https://oasys-mas.github.io/free-range-zoo/environments/wildfire/index.html)
...
with accepted passengers in wildfire.
...
agents = {
    ...
    env.agents[1]: NoopBaseline(agent_name = "firefighter_2", parallel_envs = 1),
    env.agents[2]: NoopBaseline(agent_name = "firefighter_3", parallel_envs = 1),
}

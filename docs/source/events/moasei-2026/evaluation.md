...
Below is a example evaluation script for the wildfire domain which will be used
to evaluate submitted policies. You will submit a variant of this script for us
to evaluate your policy. Please comment your code so it is easy for us to see
where you are initializing and loading your model/ weight files.
...
## Evaluation Script (Cybersecurity)

```python
"""Evaluate cybersecurity baselines on testing configurations."""
...
def test() -> None:
    ...
    """
    # TODO: For other domains, swap environment initialization and agent names
    agents = ['defender_1', 'defender_2', 'defender_3']
    ...
    for agent_name in env.possible_agents:
        if agent_name in agents:
            continue
        if not agent_name.startswith('attacker_'):
            continue

        agents[agent_name] = RandomBaseline(agent_name=agent_name, parallel_envs=args.testing_episodes) 
...
## Evaluation Script (Rideshare)

```python
"""Evaluate rideshare baselines on testing configurations."""
...
def test() -> None:
    ...
    """
    # TODO: For other domains, swap environment initialization and agent names
    agents = ['driver_1', 'driver_2', 'driver_3']

"""Wildfire Suppression Environment v0.

This module provides the original static wildfire suppression environment
where firefighter agents work together to extinguish fires.

This is the stable v0 implementation. For the latest dynamic version
with agent openness support, use:
    >>> from free_range_zoo.envs import wildfire_v1
...
from free_range_zoo.envs.wildfire.env.v0.spaces import actions, observations
from free_range_zoo.envs.wildfire.env.v0.structures.state import WildfireState
from free_range_zoo.envs.wildfire.env.v0.transitions import (
    CapacityTransition,
    EquipmentTransition,
...
class raw_env(BatchedAECEnv):
    ...
    def __init__(self,
        ...
        self.suppressant_decrease_transition = SuppressantDecreaseTransition(
            agent_shape=(self.parallel_envs, self.agent_config.num_agents),
        ...
        self.suppressant_refill_transition = SuppressantRefillTransition(
            agent_shape=(self.parallel_envs, self.agent_config.num_agents),

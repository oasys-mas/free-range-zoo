...
if __name__ == '__main__':
    ...
    parser.add_argument('--sort_by', type=str, nargs='*', choices=['calls', 'cumtime', 'file',
                        'ncalls', 'pcalls', 'line', 'name', 'nfl', 'stdname', 'tottime'], default='tottime', help='The way to sort the results')

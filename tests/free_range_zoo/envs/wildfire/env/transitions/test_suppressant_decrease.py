...
from free_range_zoo.free_range_zoo.envs.wildfire.env.transitions.suppressant_decrease import SuppressantDecreaseTransition
...
class TestFireSpreads(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.used_suppressants = torch.tensor([
            [0, 1, 1, 1],
            [0, 1, 0, 1]

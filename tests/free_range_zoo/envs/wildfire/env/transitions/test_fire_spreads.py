...
from free_range_zoo.free_range_zoo.envs.wildfire.env.transitions.fire_spreads import FireSpreadTransition
...
class TestFireSpreads(unittest.TestCase):
    ...
    def test_fire_spreads_weight_application(self):
        ...
        self.assertTrue(torch.allclose(result.fires, expected), f"""
